...
-->
        ...
        <title>Smartschool > afwezigheden</title>
    </head>
    <body>
<!--
...
-->
    ...
    <div id="slider1_container" style="position: absolute; margin: 0 auto;
        top: 0px; left: 0px; width: 100%; min-height: 100%; overflow: hidden;">
        <!-- Loading Screen -->
...
-->
                <nav class="hoofdmenu">
                    <ul>
                        <li><a class="actief" href="aanwezigheden.php">Aanwezigheden</a></li>
                        <li><a href="klaslijst.php">leerlingen</a></li>
...
<!--
einde menu Leerkracht
-->
            </header>
<!--
hoofd section
--><a class="uitlog" href="aanwezigheden.php?log=logout">klik hier om af te melden</a>
